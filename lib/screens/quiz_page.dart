...
class QuizPage extends StatelessWidget {
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _buildStatColumn(
                      ...
                      'Précision',
                      Icons.center_focus_strong, // ✅ correction ici
                    ),
                    _buildStatColumn(
  ...
  Widget _buildStatColumn(String value, String label, IconData icon, {bool glow = false}) {
    return Column(
      children: [
        Container(
          decoration: glow
...
class _QuizDetailPageState extends State<QuizDetailPage> {
  ...
  @override
  Widget build(BuildContext context) {
    if (quizCompleted) return _buildCompletionScreen();
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: showExplanation ? null : () => setState(() => selectedAnswer = index),
                    child: Container(
